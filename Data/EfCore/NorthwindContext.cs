    ...
    public partial class NorthwindContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
              ...
              .UseMySql("server=localhost;port=3306;database=northwind;user=root;password=Blbnlr.123", x => x.ServerVersion("8.0.26-mysql"));
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EmployeePerformance>(entity =>
            {
                ...
                entity.HasIndex(e => e.EmployeeEmail)
                    .HasName("employee_email_UNIQUE")
                    .IsUnique();

                entity.HasIndex(e => e.EmployeeId)
                    .HasName("employee_id_UNIQUE")
                    .IsUnique();
            ...
            modelBuilder.Entity<InventoryTransactions>(entity =>
            {
                ...
                entity.HasIndex(e => e.CustomerOrderId)
                    .HasName("customer_order_id_2");

                entity.HasIndex(e => e.ProductId)
                    .HasName("product_id_2");

                entity.HasIndex(e => e.PurchaseOrderId)
                    .HasName("purchase_order_id_2");
